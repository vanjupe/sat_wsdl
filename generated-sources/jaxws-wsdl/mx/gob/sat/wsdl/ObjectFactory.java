 ...
 * generated in the mx.gob.sat.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _AcuseValidacionEFOS_QNAME = new QName("http://schemas.datacontract.org/2004/07/Sat.Cfdi.Negocio.ConsultaCfdi.Servicio", "ValidacionEFOS");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mx.gob.sat.wsdl
     * 
     */
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Sat.Cfdi.Negocio.ConsultaCfdi.Servicio", name = "ValidacionEFOS", scope = Acuse.class)
    public JAXBElement<String> createAcuseValidacionEFOS(String value) {
        return new JAXBElement<String>(_AcuseValidacionEFOS_QNAME, String.class, Acuse.class, value);
    }
